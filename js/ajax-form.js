!(function($) {
    ...
    function tr(params, lang) {
        ...
        $('.switch-element .switch-element__one').click(function () {
            $('.switch-element .switch-element__one, .switch-element .switch-element__two').removeClass('active');
            $('.switch-element .switch-element__one').addClass('active');
            $('.switch-body .switch-element__one, .switch-body .switch-element__two').removeClass('active');
            $('.switch-body .switch-element__one').addClass('active');
        });

        $('.switch-element .switch-element__two').click(function () {
            $('.switch-element .switch-element__one, .switch-element .switch-element__two').removeClass('active');
            $('.switch-element .switch-element__two').addClass('active');
            $('.switch-body .switch-element__one, .switch-body .switch-element__two').removeClass('active');
            $('.switch-body .switch-element__two').addClass('active');
        });
